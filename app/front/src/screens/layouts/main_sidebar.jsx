...
function MainSidebar(props) {
    ...
    const toScreenConstructionInfo = () => {
        sessionStorage.setItem('parametersURL', JSON.stringify({
            project_id: "",
            request_id: "",
            progress_status: "",
        }));
                        ...
                        <ul className="nav flex-column">
                            {isShowLinkRequestOrder &&
                                ...
                                <li className="item" onClick={() => toScreenConstructionInfo()}>
                                    <span className="item__link">
                                        ...
                                        <span><Trans i18nKey="MAIN_SIDEBAR_NAV_LINK_REQUEST_NEW" /></span>
                                    </span>
                                </li>
                            }
                            ...
                            <li className="item" >
                                <Link className="item__link" 
                                    to={{pathname: LinkName.LIST_CONSTRUCTION,
                                        state: { search_keyword: "" }
                                    }}
                                >
                                    <img src={iconRequestQuote} alt="icon" />
                                    <span><Trans i18nKey="MAIN_SIDEBAR_NAV_LINK_LIST_CONSTRUCTION" /></span>
                                </Link>
                            </li>
                        </ul>
                    </nav>

                    <div className="main-sidebar__bars" onClick={() => handleNavbarSidebar(isClickNavbarSidebar)}>
