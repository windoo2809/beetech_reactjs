...
function MenuMobile(props) {
    ...
    useEffect(() => {
        ...
        if ( isMounted && isActiveSearch ) {
            const handleClickOutside = (event) => {
                if ( refMenuMobile.current && refMenuMobile.current.contains(event.target) ) {
    ...
    return(
        <div className="menu-mobile d-lg-none">
            <div id="mobile-search-project" className={`menu-mobile__search ${isActiveSearch ? 'active' : ''}`}>
                <Header
                    {...header}
                    hiddenLogoMobile={true}
                />
            ...
            <div className="menu-mobile__box" ref={refMenuMobile}>
                <div className="left">
                    {isCheckLogin && (
                        <>
                            <FontAwesomeIcon icon={faSearch} className="fas icon" onClick={handleToggleClassSearch} />
                            <span><Trans i18nKey="TITLE_SEARCH"/></span>
                        </>
                    )}
                </div>
                ...
                <div className="middle">
                    ...
                    <Link to={LinkName.TOP}>
                        <span><Trans i18nKey="LABEL_HOME"/></span>
                ...
                <div className="right">
                    <Link to={LinkName.LIST_NOTIFICATION}>
                        ...
                        <span><Trans i18nKey="WCG_9000_listNotification"/></span>
                    </Link>
                </div>
            </div>
        </div>
