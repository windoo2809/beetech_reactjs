...
class UpdateVProjectListView20220705 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function createView()
    {
        return "
            ...
            from cu_project as p
                ...
                left join cu_application a on a.estimate_id = e.estimate_id and a.status  = true
