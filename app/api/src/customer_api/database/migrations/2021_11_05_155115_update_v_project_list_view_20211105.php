...
class UpdateVProjectListView20211105 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function createView()
    {
        ...
        select 
           ...
           case -- 進捗ステータス
            ...
            when r.request_type in ( 4,5,6 )   and r.request_status = 0 and r.request_other_status in ( 1,2,3,4,5 ) then 80 -- 完了 ※要見直し
