...
class UpdateTrigger20211110 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function createTrigger() 
    {
        return "
            ...
            IF new.register_type = 0 THEN 
                ...
                , new.customer_branch_tel                       -- 電話番号
                , new.customer_branch_fax                       -- FAX番号
                , 1                                             -- 固定値：基幹システム
                , 0                                             -- 固定値：システム自動連携
            ...
            BEGIN
                ...
                IF new.update_type = 0 THEN 
                    ...
                    ,customer_branch_tel              = new.customer_branch_tel               -- 電話番号
                    ,customer_branch_fax              = new.customer_branch_fax               -- FAX番号
            ...
            BEGIN
                ...
                IF _extend_estimate_id IS NOT NULL THEN
                    ...
                    WHERE ce.estimate_id = _extend_estimate_id;
