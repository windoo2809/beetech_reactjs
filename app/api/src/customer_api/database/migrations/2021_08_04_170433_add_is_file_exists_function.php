...
class AddIsFileExistsFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    { 
        ...
        DB::statement('DROP FUNCTION IF EXISTS isFileExists;');
        DB::statement($this->createIsFileExistsFunction());
    }
    ...
    private function createIsFileExistsFunction ()
    {
        return "CREATE FUNCTION isFileExists( _file_type INT, _ref_id INT )
            RETURNS BOOL
            BEGIN
